...
class CommandLineParser:
    def __init__(self):
        ...
        from . import mconf, mdist, minit, minstall, mintro, msetup, mdeps, mtest, rewriter, msubprojects, munstable_coredata, mcompile, mdevenv
        ...
        self.add_command('deps', mdeps.add_arguments, mdeps.run,
                         help_msg='Configure the project')
